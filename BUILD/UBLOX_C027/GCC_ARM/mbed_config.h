...
#define MBED_CONF_APP_DEFAULT_PIN                            0              // set by application
...
#define MBED_CONF_APP_NETWORK_INTERFACE                      CELLULAR_UBLOX // set by application
#define MBED_CONF_LWIP_ENABLE_PPP_TRACE                      0              // set by library:lwip
#define MBED_CONF_APP_MODEM_TRACE                            1              // set by application
...
#define MBED_CONF_APP_APN                                    "data.tre.dk"  // set by application
